<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo (Redirige vers l'accueil général) -->
                ...
                <!-- Links de Navigation pour Ordinateur -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- 👨‍🏫 MENUS ENSEIGNANT (Élèves et Notes uniquement) -->
                    ...
                    <!-- 💼 MENUS GESTIONNAIRE (Classes, Matières, Paiements, Dashboard - Pas de notes) -->
                    @can('access-gestionnaire')
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <!-- Affiche le nom et le rôle pour faciliter votre soutenance -->
